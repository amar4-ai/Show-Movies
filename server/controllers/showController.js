...
export const addShow = async (req, res) => {
    try {
        ...
        if (!movie) {
            //Fetch movie detains credits from TMDB API
        ...
        showsInput.forEach(show => {
            ...
            show.time.forEach((time) => {
                ...
                console.log('Creating show:', {
                    dateTimeString,
                    showDateTime,
                    isValid: !isNaN(showDateTime.getTime())
                });
 ...
 if (showsToCreate.length > 0) {
            ...
            console.log(`${result.length} shows created successfully`);
        } else {
...
export const getShow = async (req, res) => {
    try {
        ...
        //get all upcoming for the movie
