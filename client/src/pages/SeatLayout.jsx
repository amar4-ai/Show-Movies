...
const SeatLayout = () => {
    ...
    <div key={row} className="flex gap-2 mt-2">
      <div className="flex flex-wrap items-center justify-center gap-2">
        {Array.from({ length: count}, (_, i)=>{
          ...
          return (
            <button key={seatId} onClick={()=> handleSeatClick(seatId)} className={`h-8 w-8 rounded border border-primary/30
  ...
  return show ? (
    ...
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-40 md:pt-50'>
      {/* Available Timings */}
...
<button onClick={()=>navigate('/my-bookings')} className="flex items-center gap-1 mt-20 px-20 py-3 text-sm bg-primary hover:bg-red-900 transition rounded-full font-medium 
