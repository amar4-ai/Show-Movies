...
const MovieDetails = () => {
  ...
  return show ? (
    <div className='mt-40 px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3 pt-6'>
          ...
          <div id='dateselect' className='flex items-center flex-wrap gap-4 mt-4'>
            ...
            <a href="#dateSelect" className='px-10 py-3 text-sm bg-primary hover:bg-red-900 transition rounded-md font-medium
            cursor-pointer active:scale-95'>Buy Tickets</a>
            <button onClick={handleFavorite} className='bg-gray-700 p-2.5 rounded-full transition cursor-pointer
            active:scale-95'>
              <Heart className={`w-5 h-5 ${favoriteMovies.find(movie => movie._id.toString() === id.toString()) ?
      ...
      <div className='flex justify-center mt-20'>
        <button onClick={() => { navigate('/movies'); scrollTo(0, 0) }} className='px-10 py-3 text-sm bg-primary hover:bg-primary/25 transition rounded-md font-medium cursor-pointer'>Show more</button>
